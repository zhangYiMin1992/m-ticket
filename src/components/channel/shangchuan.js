    ...
    editchk:function(){
        ...
        $('#publishform').live('submit',function(){
            ...
            var blockChk=function(obj){
                ...
                var frame=obj.find("input[name='frame[]']").val();
                ...
                obj.find("input[type='radio'][name*=frame[']").each(function(){
                    if( $(this).prop('checked') ){
                        frame=$(this).val();
                    }
                });
                ...
                if(frame=='是' && $('.sc_4 .sc_4').children().length<=5){
                    alert('请上传装裱图');
                    return false;
                }
...
$(function(){
    var boxW=$('.sc_4_main_1').width();
    var boxH=$('.sc_4_main_1').height();
    
    var img_url =$('.sc_4_main_1 img').attr('src');
    var img=new Image();
    img.src=img_url;
    var imgW=0;
    var imgH=0;
